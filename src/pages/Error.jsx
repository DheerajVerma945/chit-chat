  ...
  return (
    <div className="h-screen pt-16 flex flex-col items-center justify-center space-y-8 p-4 relative">
      <div
        ...
        style={{ backgroundImage: `url(${Error})`, opacity: 0.5, filter: "blur(2px)" ,objectFit:'contain'}}

      ></div>
      <div className="flex items-center flex-col gap-5 relative z-10  text-center">
        <h1 className="text-6xl font-bold text-black">404</h1>
        <p className="text-xl text-black">Oops! The page you are looking for does not exist.</p>
